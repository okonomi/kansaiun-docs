...
require_once 'Sample250_Error.php';
require_once 'Sample250_ActionClass.php';
require_once 'Sample250_ActionForm.php';
require_once 'Sample250_ViewClass.php';

/**
 *  Sample250 application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Sample250
 */
class Sample250_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Sample250_View_Index',
         *  ),
         */
    );
    ...
    var $class = array(
        ...
        'form'          => 'Sample250_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Sample250_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Sample250_UrlHandler',
    );
    ...
    var $plugin_search_appids = array(
         ...
         *  2. Sample250_Plugin_Foo_Bar
         *  3. Ethna_Plugin_Foo_Bar
         *
         *  'Common', 'Sample250', 'Ethna',
         */
        'Sample250', 'Ethna',
    );
